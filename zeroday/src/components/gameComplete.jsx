      ...
      <div className="bg-black min-h-screen text-lime-400 font-reno flex flex-col justify-center items-center px-6 py-10">
        ...
        />
          ...
          <p className="text-lg mb-4">
            Looks like you sucessfully infiltrated our system, <span className="text-lime-300 font-reno">{playerName}</span>!
          </p>
          <p>
            It won't be as easy the next time. 
          </p>
